package ru.rainchat.rlib.utils.config.json;
...
public class JsonConfig<T> {
    ...
    public JsonConfig(String file, Plugin plugin) {
        this.plugin = plugin;
        this.gson = new GsonBuilder().setPrettyPrinting().create();
        this.file =  new File(plugin.getDataFolder().getPath() + File.separator + file + ".json");
    }

    public JsonConfig(String file, String path) {
        this.gson = new GsonBuilder().setPrettyPrinting().create();
        this.file =  new File(path + File.separator + file + ".json");
    }
